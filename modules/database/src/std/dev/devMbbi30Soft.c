...
static long read_mbbi30(mbbi30Record *prec);

mbbi30dset devMbbi30Soft = {
    {5, NULL, NULL, init_record, NULL},
    read_mbbi30
};
epicsExportAddress(dset, devMbbi30Soft);

static long init_record(dbCommon *pcommon)
{
	mbbi30Record *prec = (mbbi30Record *)pcommon;
...
{
    mbbi30Record *prec = (mbbi30Record *) pinp->precord;
